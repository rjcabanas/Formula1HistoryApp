...
with quad1:
    ...
    # podium_img = Image.new("RGB", (400,300), (0,0,0,0))
    # podium_draw = ImageDraw.Draw(podium_img)
    # podium_draw.rectangle([50, 150, 100, 250], fill="silver")   # 2nd
    # podium_draw.rectangle([150, 100, 200, 250], fill="gold")    # 1st
    # podium_draw.rectangle([250, 180, 300, 250], fill="peru")    # 3rd
    # podium_draw.text((50, 130), f"{race_winner}", fill="white")
    # podium_draw.text((150, 80), f"{race_2nd}", fill="white")
    # podium_draw.text((250, 160), f"{race_3rd}", fill="white")
    # buf = io.BytesIO()
    # podium_img.save(buf, format="PNG")
    # base64_pod_img = base64.b64encode(buf.getvalue()).decode("utf-8")

    # st.markdown(
    #     f"""
    #     <div style="display: flex; justify-content: center;">
    #         <img src="data:image/png;base64,{base64_pod_img}" />
    #     </div>
    #     """,
