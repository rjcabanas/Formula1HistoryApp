...
df_races = pd.read_parquet("webapp/silver/races.parquet")
df_race_results = pd.read_parquet("webapp/silver/results.parquet")
df_drivers = pd.read_parquet("webapp/silver/driversDim.parquet")
df_constructors = pd.read_parquet("webapp/silver/constructors.parquet")
df_lap_data = pd.read_parquet("webapp/silver/lapsFactTable.parquet")
status = pd.read_csv("webapp/bronze/status.csv")
drivers_standings = pd.read_parquet("webapp/silver/driver_standings.parquet")
constructors_standings = pd.read_parquet("webapp/silver/constructor_standings.parquet")
seasons = pd.read_csv("webapp/bronze/seasons.csv")
